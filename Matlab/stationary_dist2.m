function g = stationary_dist2(A, a, b, par)
    ...
    db_tilde = ones(I,1); db_tilde(2:I-1) = (b(3:I) - b(1:I-2))/2; db_tilde(1) = b(2)-b(1); db_tilde(I) = b(I)-b(I-1);
    da_tilde = ones(J,1); da_tilde(2:J-1) = (b(3:I) - b(1:I-2))/2; da_tilde(1) = a(2)-a(1); da_tilde(J) = a(J)-a(J-1);
    [AAA,BBB] = meshgrid(da_tilde,db_tilde); dba_tilde = reshape(AAA .* BBB,I*J,1);
    grid_diag = spdiags(repmat(dba_tilde,Nz+1,1),0,M,M);
    
    % Convert the hisrogram to a density
